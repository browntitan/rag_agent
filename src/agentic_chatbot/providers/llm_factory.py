...
def _build_chat_model(settings: Settings, *, llm_provider: str, http_client):
...
def _build_judge_model(settings: Settings, *, judge_provider: str, http_client):
...
def build_providers(settings: Settings) -> ProviderBundle:
    ...
    chat = _build_chat_model(settings, llm_provider=llm_provider, http_client=http_client)
    judge = _build_judge_model(settings, judge_provider=judge_provider, http_client=http_client)
    embeddings = _build_embeddings_model(settings, emb_provider=emb_provider, http_client=http_client)
